...
function OpeningPreview({ opening, i, onClick }) {
  return (
    <motion.div
      ...
      whileTap={{ scale: 0.97 }}
      className="flex overflow-clip flex-col items-center h-[20.5vw] w-37/100 border-[0.1vw] border-white/50 rounded-[1vw] bg-gray-950/50 cursor-pointer scale-90"
      onClick={onClick}
    >
      ...
      <div className="flex flex-col px-[0.5vw] pt-[0.5vw] ml-[0.2vw]">
        <i className="text-white/80 text-[1.3vw] !font-[900] capitalize w-[15vw] truncate">
          {opening.title}
        </i>
